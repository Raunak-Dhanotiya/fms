...
const routes: Routes = [
  ...
  },
  {
    path: "geo-loc",
    loadChildren: () =>
      import("./ui/location/location.module").then((m) => m.LocationModule),
    canActivate: [AuthGuard],
  },
  {
    path: "location",
  ...
  },
  {
    path: "reports",
    loadChildren: () =>
      import("./ui/booking/widgets/booking-reports/booking-reports.module").then(
        (m) => m.BookingReportsModule
      ),
    canActivate: [AuthGuard],
  },
  {
  ...
  { path: "room-cat", redirectTo: "room-category", pathMatch: "full" },
  { path: "rooms", redirectTo: "room-category", pathMatch: "full" },
  { path: "room-category", component: RommsComponent, canActivate: [AuthGuard] },
  {
