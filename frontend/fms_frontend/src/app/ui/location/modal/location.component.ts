  ...
  ngAfterViewInit() {
   ...
   loadCntry() {
     this.cntrySrv.getALLCountry().subscribe((res: any) => {
       // Ensure res is an array before using array methods
       const countryList = Array.isArray(res) ? res : [];
       this.enumCntry = countryList.map((i: any) => {
         if (i && i.code && i.name) {
       ...
       this.enumCntry = [new CountryFilterInput('', 'Make a selection')];
     });
   }
   ...
   loadRegn() {
     this.regnSrv.getALLRegn().subscribe((res: any) => {
       // Ensure res is an array before using array methods
       const regnList = Array.isArray(res) ? res : [];
       this.enumRegn = regnList.map((i: any) => {
         if (i && i.id && i.name) {
           i.name = i.id + ' - ' + i.name;
         }
         return i;
       ...
       this.enumRegn = [new RegnFilterInput('', 'Make a selection', '')];
     });
   }
   ...
   loadState() {
     this.stateSrv.getALLState().subscribe((res: any) => {
       // Ensure res is an array before using array methods
       const stateList = Array.isArray(res) ? res : [];
       this.enumState = stateList.map((i: any) => {
         if (i && i.id && i.name) {
           i.name = i.id + ' - ' + i.name;
         }
         return i;
       ...
       this.enumState = [new StateFilterInput('', 'Make a selection', '', '')];
     });
   }
   ...
   loadCity() {
     this.citySrv.getALLCity().subscribe((res: any) => {
       // Ensure res is an array before using array methods
       const cityList = Array.isArray(res) ? res : [];
       this.enumCity = cityList.map((i: any) => {
         if (i && i.id && i.name) {
           i.name = i.id + ' - ' + i.name;
         }
         return i;
       ...
       this.enumCity = [new CityFilterInput('', 'Make a selection', '', '', '')];
     });
   }
