  ...
  constructor(
   ...
   // this.currentDate = this.datePipe.transform(new Date(), "yyyy/MM/dd hh:mm:ss");
    ...
    this.frmEmployeeDetails = this.formBuilder.group({
      ...
      emStatus: [null, [Validators.required]],
      idNumber: [''],
      birthDate: [''],
  ...
  set value(value: EmployeeDetails) {
      setTimeout(() => {
        this.frmEmployeeDetails.patchValue({
          emId: value.emId,
          initials: this.normalizeSelectValue(value.initials),
          firstName: value.firstName,
          lastName: value.lastName,
          maidenName: value.maidenName,
          aliasName: value.aliasName,
          email: value.email,
          emstdId: this.normalizeSelectValue(value.emstdId),
          emStatus: this.normalizeSelectValue(value.emStatus),
          idNumber: value.idNumber,
          birthDate: value.birthDate,
          gender: this.normalizeSelectValue(value.gender),
          compName: value.compName,
          dateJoin: value.dateJoin,
          dateLeave: value.dateLeave,
          lineMngr:this.normalizeSelectValue(value.lineMngr),
          emCode:value.emCode
        });
